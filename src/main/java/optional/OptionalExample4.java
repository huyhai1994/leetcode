...
public class OptionalExample4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Optional.map: " + multiOptional.map(gender -> gender.map(String::toUpperCase)).get());
        System.out.println("Optional.flatMap: " + multiOptional.flatMap(gender -> gender.map(String::toUpperCase)).get());
        Optional<String> name = Optional.of("backend");
